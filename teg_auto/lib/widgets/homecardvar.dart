                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        width: size.width,
                        child: Image.asset('assets/images/bmw-m8-coupe-onepager-sp-desktop.jpg', fit: BoxFit.fill,),
                    ),),
                    Positioned(
                    ...
                    Positioned(
                      ...
                      child: Text("Bmw", style: TextStyle(fontSize: size.height * 0.040, fontWeight: FontWeight.bold)),),
                    Positioned(
                      bottom: size.height * 0.13,
                      left: size.width * 0.02,
                      child: Text("M8 Competition", style: TextStyle(fontSize: size.height * 0.035),),),
                    Positioned(
                      bottom: size.height * 0.13,
                      right: size.width * 0.02,
                      child: Text("100000 €", style: TextStyle(fontSize: size.height * 0.035),),),
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("10 km", style: TextStyle(fontSize: size.height * 0.030),)),),),
                    Positioned(
                      bottom: size.height * 0.045,
